...
//public:
////    void demarrer();
//    std::string afficherCouleur(bool couleur);
...
//    bool bouger(std::pair<int,int> coordoneeInit, std::pair<int,int> coordoneeFinale);
//    bool bougerRoi(bool tour, std::pair<int, int> init, std::pair<int, int> finale);
//    void afficherEchiquier();

//private:
//    Echequier echequier_;
//    QString guimove_;
//    std::string mouvement1_ = "";
//    std::string mouvement2_ = "";
//    bool tour_ = true;
//public slots:
//    void getEntree(QString input);

//signals:
//    void envoyerSignal(QString signal);
